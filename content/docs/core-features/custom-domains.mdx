...
description: Beautiful local domains for every project with automatic hosts file management
-icon: Globe
---
...
<Accordions type="single">
  <Accordion title="Domain Not Resolving">
    <b>Problem:</b> Can't access <code>myapp.local</code> after creating site<br/><br/>
    <b>Solutions:</b>
    <ol>
      <li>Check that site is running in DAMP dashboard</li>
