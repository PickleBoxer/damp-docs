...
Add **Claude Code CLI** to your project with a single click during creation. Get an AI coding assistant that understands your entire codebase and helps you build faster.
...
Claude Code CLI has context about your entire project:
...
This means better, more relevant suggestions!
...
Same environment, same context, better assistance!
...
Understand new concepts and patterns:
