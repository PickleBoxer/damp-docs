...
Download the latest Windows installer from our [releases page](https://github.com/your-org/damp/releases).
...
<Cards>
  <Card title="Create Your First Site" href="/docs/quick-start">
  ...
  <Card title="Configuration" href="/docs/configuration">
    Customize DAMP to match your workflow
  </Card>
</Cards>

<Callout type="tip">
  **Need Help?** Join our [Discord community](https://discord.gg/your-server) for support and tips from other DAMP users!
</Callout>
